...
def show_home():
    ...
    st.header('''Découvrez CinéCreuse, le moteur de recommandation de films conçu pour les amoureux du cinéma en Creuse. Entrez un film que vous aimez, et laissez notre système intelligent vous proposer des films similaires qui correspondent à vos goûts.
